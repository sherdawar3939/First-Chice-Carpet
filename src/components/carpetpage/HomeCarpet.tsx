    ...
    <div>
      <div className="w-screen justify-center text-center items-center pl-20 pr-20">
        ...
        <h1 className="font-normal text-sm text-pretty">
          ...
          home. <br />
          Choose from a wide range of styles from our Dubai interior design
          company that will perfectly complement your décor while offering soft,
