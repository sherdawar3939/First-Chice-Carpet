...
const LivingRoomCarpet: React.FC = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        setLoading(true);
        const res = await fetch("/api/product?subcategory=Living-room-carpet");
    ...
    <div>
      <div className="w-screen justify-center text-center items-center px-5">
        ...
        <h1 className="font-normal text-sm text-justify">
          ...
          bold, statement piece or a subtle, neutral design, we have a variety
...
export default LivingRoomCarpet;
